...
<body>
    ...
    */
    ...
    //alterando o valor do cookie
    $novo_valor = "Curso Análise e Desenvolvimento de Sistemas";
    setcookie($nome_cookie, $novo_valor, time() + 60);

    echo "<br><br>Novo valor: ".$_COOKIE['faculdade'];
    
    // excluindo o cookie
    setcookie($nome_cookie,"",time() - 60);
    ?>
</body>
</html>